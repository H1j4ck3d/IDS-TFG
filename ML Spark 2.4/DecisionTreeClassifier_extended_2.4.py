...
base_path = "."
vector_assembler_path = "{}/data/numeric_vector_assembler_DTE.bin".format(base_path)
...
#Funcion para el FPR individual por clase
...
plt.show()
fig.savefig('confusion_matrix_dte.png', dpi=fig.dpi)