...
for feature in string_features_zeek:
    ...
    base_path = "."
    str_indexer_model_path = "{}/data/str_indexer_RN/str_indexer_model_RN_{}.bin".format(base_path, feature)
...
nb = NaiveBayes(labelCol='attack_cat_index', featuresCol='features', predictionCol='prediction')
nb = nb.fit(train)
