...
features_to_drop_argus = ['srcip','dstip','swin','dwin','stcpb','dtcpb','smeansz','dmeansz','trans_depth',
...
dataset = dataset.drop(*features_to_drop_argus)
dataset.show(25)
...
for feature in string_features_argus:
    ...
    base_path = "."
    str_indexer_model_path = "{}/data/str_indexer/str_indexer_model_NN_{}.bin".format(base_path, feature)
...
vector_assembler = VectorAssembler(inputCols= vector_features_argus, outputCol="features")
dataset = vector_assembler.transform(dataset)
base_path = "."
vector_assembler_path = "{}/data/numeric_vector_assembler_NN.bin".format(base_path)
